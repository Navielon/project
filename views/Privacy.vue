<template>
<div>
    <img src="/assets/img/a2.png" class="noselect header_img" draggable="false"/>
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="descr">Настоящая политика обработки персональных данных
                ...
                данных и меры по обеспечению безопасности персональных данных, предпринимаемые <span id="genName" data-scroll-to="#privacyName" class="link mark">Волос Ярослав Валериевич</span> (далее – Оператор).
            </div>
            <div class="ol">
                ...
                получить о посетителях веб-сайта <span id="privacyURL" data-scroll-to="#prefixURL" class="link mark">https://loliland.ru</span>.
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="ol">
                ...
                по сетевому адресу <span data-scroll-to="#prefixURL" class="link mark">https://loliland.ru</span>;
                </div>
                ...
                к
                определенному или определяемому Пользователю веб-сайта <span data-scroll-to="#prefixURL" class="link mark">https://loliland.ru</span>;
                </div>
                <div class="li">2.9. Пользователь – любой посетитель веб-сайта <span data-scroll-to="#prefixURL" class="link mark">https://loliland.ru</span>;</div>
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="ol">
                <div class="li">4.1. Цель обработки персональных данных Пользователя — информирование Пользователя посредством отправки электронных писем.</div>
                ...
                направив Оператору письмо на адрес электронной почты <span data-scroll-to="#privacyEmail" class="link mark">loliland@gmail.com</span> с пометкой «Отказ от
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="ol">
                ...
                формы, расположенные на сайте <span data-scroll-to="#prefixURL" class="link mark">https://loliland.ru</span>. Заполняя соответствующие формы
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="ol">
                ...
                на адрес электронной почты Оператора <span data-scroll-to="#privacyEmail" class="link mark">loliland@gmail.com</span> с пометкой «Актуализация
                персональных данных».
                </div>
                ...
                электронный адрес Оператора <span data-scroll-to="#privacyEmail" class="link mark">loliland@gmail.com</span> с пометкой «Отзыв согласия на
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <div class="ol">
                ...
                помощью электронной почты <span data-scroll-to="#privacyEmail" class="link mark">loliland@gmail.com</span>.
                </div>
                ...
                по адресу <span id="genURLLink" data-scroll-to="#prefixURLLink" class="link mark">https://loliland.ru/privacy</span>.
                </div>
            </div>
        </div>
    </div>
